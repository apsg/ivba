...
return [
    ...
    */
    ...
    'email'                => 'Atrybut:attribute must be a valid email address.',
    'exists'               => 'Atrybutselected :attribute is invalid.',
    ...
    'max'                  => [
        'numeric' => 'Atrybut:attribute may not be greater than :max.',
    ...
    'min'                  => [
        'numeric' => 'Atrybut:attribute must be at least :min.',
    ...
    'numeric'              => 'Atrybut:attribute must be a number.',
    'present'              => 'Atrybut:attribute field must be present.',
    'regex'                => 'Atrybut:attribute format is invalid.',
    'required'             => 'Atrybut:attribute field is required.',
    ...
    'string'               => 'Atrybut:attribute must be a string.',
    'timezone'             => 'Atrybut:attribute must be a valid zone.',
    'unique'               => 'Atrybut:attribute has already been taken.',
