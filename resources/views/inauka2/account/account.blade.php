    ...
    <section class="page content">
        <div class="container">
            ...
            <ul class="nav nav-tabs nav-pills nav-justified" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link active" id="ranking-tab" data-bs-toggle="tab" data-bs-target="#ranking" role="tab"
                       aria-controls="ranking" aria-selected="true">Ranking</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" id="courses-tab" data-bs-toggle="tab" data-bs-target="#courses" role="tab"
                ...
                <li class="nav-item">
                    <a class="nav-link" id="finance-tab" data-bs-toggle="tab" data-bs-target="#finance" role="tab"
