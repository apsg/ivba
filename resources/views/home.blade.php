            ...
            <div class="col-md-12">
              ...
              <div class="box box-info">
                ...
                <div class="box-footer clearfix">
                  <a href="{{ url('admin/user') }}" class="btn btn-sm btn-info btn-flat pull-left">Przejdź do spisu użytkowników</a>
                </div>
                <!-- /.box-footer -->
              </div>
              <!-- /.box -->
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="progress-group">
                    ...
                    <div class="progress sm">
                        <div class="progress-bar progress-bar-green" style="width: {{ \Statistics::procEmailsOpened($startDate, $endDate) }}%"></div>
                    </div>
                </div>
                ...
                <div class="progress-group">
                    ...
                    <div class="progress sm">
                        <div class="progress-bar progress-bar-yellow" style="width: {{ \Statistics::procEmailsClicked($startDate, $endDate) }}%"></div>
                    </div>
                </div>
                ...
                <div class="progress-group">
                    ...
                    <div class="progress sm">
                        <div class="progress-bar progress-bar-yellow" style="width: {{ \Statistics::procEmailsUnsubscribed($startDate, $endDate) }}%"></div>
                    </div>
                </div>
            </div>
