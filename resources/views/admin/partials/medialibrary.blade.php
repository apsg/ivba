                ...
                <div class="modal-body">
                    <div>
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#select-media" aria-controls="select-media"
                                                                      role="tab" data-toggle="tab">Wybierz</a></li>
                            <li role="presentation"><a href="#add-new" aria-controls="add-new" role="tab"
                                                       data-toggle="tab">Dodaj nowy</a></li>
                        </ul>
                            ...
                            <div role="tabpanel" class="tab-pane" id="add-new">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <form id="add-new-form" action="{{ url('admin/images') }}" method="post"
